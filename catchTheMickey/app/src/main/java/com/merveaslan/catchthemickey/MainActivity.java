package com.merveaslan.catchthemickey;
        ...
        new CountDownTimer(10000,1000) {
            ...
            public void onFinish() {
                ...
                if(score<5) {
                    ...
                    alert.setMessage("Oyun yeniden başlatılsın mı?");
                    ...
                    alert.setMessage("Skorunu görmek için devam et");
                    alert.setPositiveButton("Devam", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            writeScore = Integer.toString(score);
                            Intent intent  = new Intent(MainActivity.this,MainActivity2.class);
                            intent.putExtra("inputScore",writeScore);
                            startActivity(intent);
